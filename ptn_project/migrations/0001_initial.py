    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discussion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ptn_project.discussion')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ...
                ('project_genre', models.ManyToManyField(related_name='project', to='accounts.genretag')),
                ('project_stack', models.ManyToManyField(related_name='project', to='accounts.stacktag')),
                ('project_university', models.ManyToManyField(related_name='project', to='accounts.universitytag')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ptn_project.project')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feedback_writer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.account')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ptn_project.project')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feedback', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ptn_project.userfeedback')),
            ],
        ),
    ]
